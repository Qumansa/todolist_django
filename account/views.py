...
def logoutView(request):
    try:
        ...
        res = response.Response()
        res.delete_cookie(
            settings.SIMPLE_JWT['AUTH_COOKIE'], samesite='strict')
        res.delete_cookie(
            settings.SIMPLE_JWT['AUTH_COOKIE_REFRESH'], samesite='strict')
        res.delete_cookie("X-CSRFToken", samesite='strict')
        res.delete_cookie("csrftoken", samesite='strict')
        return res
    except:
